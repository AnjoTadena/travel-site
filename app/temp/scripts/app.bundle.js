            ...
            this.itemsToReavel.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler() {
                        (0, _jquery2.default)(currentItem).addClass('reavel-item--is-visible');
                    },
...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.siteHeader = (0, _jquery2.default)('.site-header');
        this.triggerHeaderEl = (0, _jquery2.default)('.large-hero__title');
        ...
        value: function createPageSectionWayPoint() {
            ...
            this.pageSections.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction === 'down') {
                            var matchingHeaderLink = currentElement.getAttribute('data-matching-link');
